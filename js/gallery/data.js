...
export const GALLERY_ITEMS = [
  ...
  { id: 'v10', type: 'video', src: '/img/gallery/videos/video-10-cupcakes.webm',       poster: '/img/gallery/gallery-16.webp', title: 'Видео: праздничные капкейки',     desc: 'Капкейки ручной работы с ярким кремовым оформлением', tags: ['bday'] },
  ...
  { id: 'v16', type: 'video', src: '/img/gallery/videos/video-16-moon-stars.webm',     poster: '/img/gallery/gallery-25.webp', title: 'Видео: торт «Луна и звёзды»',    desc: 'Голубой торт с космическими мотивами и золотыми звёздами', tags: ['bday'] },

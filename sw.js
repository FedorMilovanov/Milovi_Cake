...
const CACHE_NAME = 'milovi-cake-v2026.05.16-r2';
const PRECACHE = [
  '/',
  '/css/style.css?v=20260516r2',
  '/css/mc-2026.css?v=20260516r2',
  '/css/premium-overrides.css?v=20260516r2',
  '/js/main.js?v=20260516r2',
  '/js/nav.js?v=20260516r2',
  '/js/mc-2026.js?v=20260516r2',
  '/img/head_mobile.avif',
  '/img/head_desktop.avif',
  '/img/head_mobile.webp',
  '/img/head_desktop.webp',
  '/manifest.json',
  '/favicon.svg?v=20260516r2'
];
